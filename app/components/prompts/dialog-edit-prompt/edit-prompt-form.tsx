    ...
    >
      {isDrawer && (
        <div className="border-border mb-2 flex items-center justify-between border-b px-4 pb-2">
          <h2 className="text-lg font-medium">Edit prompt</h2>
      ...
      <div className="px-6 py-4">
        <div className="bg-muted/50 mb-6 rounded-lg p-3">
          <p className="text-sm">
            ...
            Changes will be reflected immediately when the prompt is @mentioned.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmitAction} className="space-y-6">
          ...
          <Button type="submit" className="w-full" disabled={isLoading}>
            {isLoading ? "Updating Prompt..." : "Update Prompt"}
          </Button>
        </form>
      </div>
    </div>
