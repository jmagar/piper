...
import { ToolsSection } from "../dialog-create-agent/tools-section"
...
type EditAgentFormProps = {
  ...
  repository: string
  setRepositoryAction: (e: React.ChangeEvent<HTMLInputElement>) => void
  error: { [key: string]: string }
  isLoading: boolean
  handleInputChangeAction: (
    e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
  ) => void
  handleSelectChangeAction: (value: string) => void
  handleToolsChangeAction: (selectedTools: string[]) => void
...
export function EditAgentForm({
  ...
  const handleMcpToggle = (serverKey: string, checked: boolean) => {
    ...
    handleSelectChangeAction(newSelection.join(','))
  }
    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <form onSubmit={handleSubmitAction} className="space-y-6">
          ...
          <ToolsSection onSelectTools={handleToolsChangeAction} />
          ...
          <Button type="submit" className="w-full" disabled={isLoading}>
            {isLoading ? "Updating Agent..." : "Update Agent"}
          </Button>
        </form>
      </div>
    </div>
