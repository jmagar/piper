...
- CRITICAL: STOP USING THIS RULE UNTIL A NEW Climb IS STARTED- If a move depends on a skipped move, YOU MUST ASK the user if they want to return to the skipped move first
...
- If they close a Climb, move it to complete
- CRITICAL: STOP ADDING THE Climb-TRACKING TEXT TO RESPONSES
- CRITICAL: STOP USING THIS RULE UNTIL A NEW Climb IS STARTED### Console Debugging
```typescript
