		...
		<div
			...
			<div style={{ padding: "20px 20px 5px", display: "flex", flexDirection: "column", gap: "16px" }}>
				...
				<VSCodeTextField
					...
					value={searchQuery}
					onInput={(e: React.FormEvent<HTMLInputElement>) => setSearchQuery((e.target as HTMLInputElement).value)}>
					<div
						slot="start"
				...
				<div
					...
					<div
						...
						<VSCodeDropdown
							...
							onChange={(e: React.FormEvent<HTMLSelectElement>) => setSelectedCategory((e.target as HTMLSelectElement).value || null)}>
				...
				<div
					...
					<VSCodeRadioGroup
						...
						value={sortBy}
						onChange={(e: React.FormEvent<HTMLInputElement>) => setSortBy((e.target as HTMLInputElement).value as typeof sortBy)}>
